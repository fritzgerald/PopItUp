...
//  PopItUp
//
//  Created by MUISEROUX Fritzgerald on 16/03/2018.
...
class PopUpViewController: UIViewController {
    ...
    init(backgroundStyle: PopupBackgroundStyle,
        ...
        interactiveTransitionning = transitionning.interactiveTransitionning(inView: containedViewContoller.view,
                                                                             forController: containedViewContoller)
